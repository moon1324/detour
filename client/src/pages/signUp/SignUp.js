                ...
                <S.SignUpFormContainer>
                    <S.SignUpForm onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <S.SignUpLabel htmlFor="email">
                                ...
                                <>
                                    <S.AuthCodeWrapper>
                                        <S.SignUpLabel htmlFor="authCode">
                                            ...
                                            />
                                            <S.ErrorMessageWrapper>{authCodeError && <S.ErrorMessage>{authCodeError}</S.ErrorMessage>}</S.ErrorMessageWrapper>
                                        </S.SignUpLabel>
                                        <DetourButton
                                            variant={"gray"}
                                            shape={"small"}
                            ...
                            {isAuthCodeVerified && <S.SuccessMessage>이메일 인증에 성공하였습니다!</S.SuccessMessage>}
                        </S.SignUpLabel>
